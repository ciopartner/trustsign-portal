...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Debitcard'
        db.create_table(u'payment_debitcard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('banco', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('agencia', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('conta', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
        ))
        db.send_create_signal(u'payment', ['Debitcard'])

        # Adding model 'Boleto'
        db.create_table(u'payment_boleto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nosso_numero', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('vencimento', self.gf('django.db.models.fields.DateField')()),
            ('boleto_html', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'payment', ['Boleto'])

        # Deleting field 'Source.bankcard'
        db.delete_column(u'payment_source', 'bankcard_id')

        # Adding field 'Transaction.bankcard'
        db.add_column(u'payment_transaction', 'bankcard',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sources', null=True, to=orm['payment.Bankcard']),
                      keep_default=False)

        # Adding field 'Transaction.debitcard'
        db.add_column(u'payment_transaction', 'debitcard',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sources', null=True, to=orm['payment.Debitcard']),
                      keep_default=False)

        # Adding field 'Transaction.boleto'
        db.add_column(u'payment_transaction', 'boleto',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sources', null=True, to=orm['payment.Boleto']),
                      keep_default=False)

        # Adding field 'Transaction.date_approved'
        db.add_column(u'payment_transaction', 'date_approved',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bankcard.credito_cpf'
        db.add_column(u'payment_bankcard', 'credito_cpf',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bankcard.credito_telefone'
        db.add_column(u'payment_bankcard', 'credito_telefone',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Debitcard'
        db.delete_table(u'payment_debitcard')

        # Deleting model 'Boleto'
        db.delete_table(u'payment_boleto')

        # Adding field 'Source.bankcard'
        db.add_column(u'payment_source', 'bankcard',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sources', null=True, to=orm['payment.Bankcard'], blank=True),
                      keep_default=False)

        # Deleting field 'Transaction.bankcard'
        db.delete_column(u'payment_transaction', 'bankcard_id')

        # Deleting field 'Transaction.debitcard'
        db.delete_column(u'payment_transaction', 'debitcard_id')

        # Deleting field 'Transaction.boleto'
        db.delete_column(u'payment_transaction', 'boleto_id')

        # Deleting field 'Transaction.date_approved'
        db.delete_column(u'payment_transaction', 'date_approved')

        # Deleting field 'Bankcard.credito_cpf'
        db.delete_column(u'payment_bankcard', 'credito_cpf')

        # Deleting field 'Bankcard.credito_telefone'
        db.delete_column(u'payment_bankcard', 'credito_telefone')
    ...
    models = {
        ...
        u'payment.boleto': {
            ...
            'boleto_html': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nosso_numero': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
