...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Debitcard.debitcard_url'
        db.add_column(u'payment_debitcard', 'debitcard_url',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Debitcard.debitcard_url'
        db.delete_column(u'payment_debitcard', 'debitcard_url')
