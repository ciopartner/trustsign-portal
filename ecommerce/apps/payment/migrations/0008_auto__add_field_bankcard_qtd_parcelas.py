...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bankcard.qtd_parcelas'
        db.add_column(u'payment_bankcard', 'qtd_parcelas',
                      self.gf('django.db.models.fields.IntegerField')(default=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bankcard.qtd_parcelas'
        db.delete_column(u'payment_bankcard', 'qtd_parcelas')
    ...
    models = {
        ...
        u'payment.bankcard': {
            ...
            'qtd_parcelas': ('django.db.models.fields.IntegerField', [], {'default': '1', 'blank': 'True'}),
