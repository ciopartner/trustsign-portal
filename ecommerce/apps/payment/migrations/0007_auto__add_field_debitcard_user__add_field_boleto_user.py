...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Debitcard.user'
        db.add_column(u'payment_debitcard', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='debitcards', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Boleto.user'
        db.add_column(u'payment_boleto', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='boletos', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Debitcard.user'
        db.delete_column(u'payment_debitcard', 'user_id')

        # Deleting field 'Boleto.user'
        db.delete_column(u'payment_boleto', 'user_id')
    ...
    models = {
        ...
        u'payment.boleto': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'boletos'", 'null': 'True', 'to': u"orm['auth.User']"}),
        ...
        u'payment.debitcard': {
            ...
            'debitcard_url': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'debitcards'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'payment.source': {
