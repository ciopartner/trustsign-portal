...
class PaymentDetailsView(views.PaymentDetailsView, OscarToCRMMixin):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.POST.get('source-type') == 'moeda-digital':
    ...
    def handle_payment(self, order_number, total_incl_tax, **kwargs):
        ...
        if payment_source == 'moeda-digital':
            return self.handle_payment_moedadigital(order_number, total_incl_tax, **kwargs)
    ...
    def handle_payment_moedadigital(self, order_number, total_incl_tax, **kwargs):
        """
        ...
        transaction_id = facade.post_payment(self.request, order_number, total_incl_tax.incl_tax)
        if transaction_id:
            msg = facade.post_payment(self.request, order_number, total_incl_tax)
        ...
        source_type, _ = SourceType.objects.get_or_create(name='moedadigital')
        ...
        source.create_deferred_transaction("debit", total_incl_tax.incl_tax, reference='', status=1)
