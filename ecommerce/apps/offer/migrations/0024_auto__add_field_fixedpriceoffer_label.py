...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FixedPriceOffer.label'
        db.add_column(u'offer_fixedpriceoffer', 'label',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FixedPriceOffer.label'
        db.delete_column(u'offer_fixedpriceoffer', 'label')
