...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FixedPriceOffer'
        db.create_table(u'offer_fixedpriceoffer', (
        ...
        db.send_create_signal(u'offer', ['FixedPriceOffer'])

        # Adding model 'FixedPriceOfferItem'
        db.create_table(u'offer_fixedpriceofferitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('offer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['offer.FixedPriceOffer'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fixed_price_offer_items', to=orm['catalogue.Product'])),
            ('price_discount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
        ))
        db.send_create_signal(u'offer', ['FixedPriceOfferItem'])


    def backwards(self, orm):
        # Deleting model 'FixedPriceOffer'
        db.delete_table(u'offer_fixedpriceoffer')

        # Deleting model 'FixedPriceOfferItem'
        db.delete_table(u'offer_fixedpriceofferitem')
