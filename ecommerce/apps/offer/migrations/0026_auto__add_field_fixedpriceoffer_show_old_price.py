...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FixedPriceOffer.show_old_price'
        db.add_column(u'offer_fixedpriceoffer', 'show_old_price',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FixedPriceOffer.show_old_price'
        db.delete_column(u'offer_fixedpriceoffer', 'show_old_price')
    ...
    models = {
        ...
        u'offer.fixedpriceoffer': {
            ...
            'show_old_price': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'status': ('django.db.models.fields.CharField', [], {'default': "u'Open'", 'max_length': '64'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        u'offer.fixedpriceofferitem': {
            'Meta': {'object_name': 'FixedPriceOfferItem'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'items'", 'to': u"orm['offer.FixedPriceOffer']"}),
            'price_discount': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'fixed_price_offer_items'", 'to': u"orm['catalogue.Product']"})
        },
        u'offer.range': {
