...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FixedPriceOffer.title'
        db.add_column(u'offer_fixedpriceoffer', 'title',
                      self.gf('django.db.models.fields.CharField')(default='<editar>', max_length=128),
                      keep_default=False)


        # Changing field 'FixedPriceOffer.start_datetime'
        db.alter_column(u'offer_fixedpriceoffer', 'start_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 29, 0, 0)))

        # Changing field 'FixedPriceOffer.end_datetime'
        db.alter_column(u'offer_fixedpriceoffer', 'end_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 29, 0, 0)))

    def backwards(self, orm):
        # Deleting field 'FixedPriceOffer.title'
        db.delete_column(u'offer_fixedpriceoffer', 'title')


        # Changing field 'FixedPriceOffer.start_datetime'
        db.alter_column(u'offer_fixedpriceoffer', 'start_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'FixedPriceOffer.end_datetime'
        db.alter_column(u'offer_fixedpriceoffer', 'end_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'offer.fixedpriceoffer': {
            'Meta': {'object_name': 'FixedPriceOffer'},
        ...
        u'offer.fixedpriceofferitem': {
            'Meta': {'object_name': 'FixedPriceOfferItem'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': u"orm['offer.FixedPriceOffer']"}),
            'price_discount': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fixed_price_offer_items'", 'to': u"orm['catalogue.Product']"})
        },
        u'offer.range': {
