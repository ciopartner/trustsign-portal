...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_product', 'product_code',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.product_line'
        db.add_column(u'catalogue_product', 'product_line',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.product_term'
        db.add_column(u'catalogue_product', 'product_term',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'catalogue_product', 'product_code')

        # Deleting field 'Product.product_line'
        db.delete_column(u'catalogue_product', 'product_line')

        # Deleting field 'Product.product_term'
        db.delete_column(u'catalogue_product', 'product_term')
    ...
    models = {
        ...
        u'catalogue.product': {
            ...
            'product_line': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'product_options': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['catalogue.Option']", 'symmetrical': 'False', 'blank': 'True'}),
            'product_term': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
