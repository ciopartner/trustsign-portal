...
class Voucher(Model):
    ...
    customer_address2 = CharField(max_length=32, blank=True, default='')
    customer_address3 = CharField(max_length=128, blank=True, default='')
    customer_address4 = CharField(max_length=128, blank=True, default='')
