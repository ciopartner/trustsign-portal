...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Emissao.emission_revoke_password'
        db.add_column(u'certificados_emissao', 'emission_revoke_password',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Emissao.emission_revoke_password'
        db.delete_column(u'certificados_emissao', 'emission_revoke_password')
