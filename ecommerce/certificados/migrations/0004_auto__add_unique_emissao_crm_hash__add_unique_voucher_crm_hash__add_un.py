...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Emissao', fields ['crm_hash']
        db.create_unique(u'certificados_emissao', ['crm_hash'])

        # Adding unique constraint on 'Voucher', fields ['crm_hash']
        db.create_unique(u'certificados_voucher', ['crm_hash'])

        # Adding unique constraint on 'Revogacao', fields ['crm_hash']
        db.create_unique(u'certificados_revogacao', ['crm_hash'])


    def backwards(self, orm):
        # Removing unique constraint on 'Revogacao', fields ['crm_hash']
        db.delete_unique(u'certificados_revogacao', ['crm_hash'])

        # Removing unique constraint on 'Voucher', fields ['crm_hash']
        db.delete_unique(u'certificados_voucher', ['crm_hash'])

        # Removing unique constraint on 'Emissao', fields ['crm_hash']
        db.delete_unique(u'certificados_emissao', ['crm_hash'])
