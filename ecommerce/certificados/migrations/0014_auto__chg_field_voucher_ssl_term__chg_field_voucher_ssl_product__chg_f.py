...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Voucher.ssl_term'
        db.alter_column(u'certificados_voucher', 'ssl_term', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Voucher.ssl_product'
        db.alter_column(u'certificados_voucher', 'ssl_product', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Voucher.ssl_line'
        db.alter_column(u'certificados_voucher', 'ssl_line', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Voucher.ssl_term'
        db.alter_column(u'certificados_voucher', 'ssl_term', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Voucher.ssl_product'
        db.alter_column(u'certificados_voucher', 'ssl_product', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Voucher.ssl_line'
        db.alter_column(u'certificados_voucher', 'ssl_line', self.gf('django.db.models.fields.CharField')(max_length=16))
