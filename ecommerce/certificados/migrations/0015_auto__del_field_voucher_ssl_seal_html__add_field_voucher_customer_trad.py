...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Voucher.ssl_seal_html'
        db.delete_column(u'certificados_voucher', 'ssl_seal_html')

        # Adding field 'Voucher.customer_tradename'
        db.add_column(u'certificados_voucher', 'customer_tradename',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Voucher.order_line'
        db.add_column(u'certificados_voucher', 'order_line',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'vouchers', null=True, to=orm['order.Line']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Voucher.ssl_seal_html'
        db.add_column(u'certificados_voucher', 'ssl_seal_html',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

        # Deleting field 'Voucher.customer_tradename'
        db.delete_column(u'certificados_voucher', 'customer_tradename')

        # Deleting field 'Voucher.order_line'
        db.delete_column(u'certificados_voucher', 'order_line_id')
    ...
    models = {
        ...
        u'partner.stockrecord': {
            ...
            'partner_sku': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'price_currency': ('django.db.models.fields.CharField', [], {'default': "'BRL'", 'max_length': '12'}),
