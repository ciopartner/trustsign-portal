...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Voucher.customer_callback_username'
        db.delete_column(u'certificados_voucher', 'customer_callback_username')

        # Deleting field 'Voucher.customer_callback_password'
        db.delete_column(u'certificados_voucher', 'customer_callback_password')

        # Adding field 'Voucher.ssl_key_size'
        db.add_column(u'certificados_voucher', 'ssl_key_size',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Voucher.ssl_username'
        db.add_column(u'certificados_voucher', 'ssl_username',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Voucher.ssl_password'
        db.add_column(u'certificados_voucher', 'ssl_password',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Voucher.customer_callback_username'
        db.add_column(u'certificados_voucher', 'customer_callback_username',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Voucher.customer_callback_password'
        db.add_column(u'certificados_voucher', 'customer_callback_password',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Voucher.ssl_key_size'
        db.delete_column(u'certificados_voucher', 'ssl_key_size')

        # Deleting field 'Voucher.ssl_username'
        db.delete_column(u'certificados_voucher', 'ssl_username')

        # Deleting field 'Voucher.ssl_password'
        db.delete_column(u'certificados_voucher', 'ssl_password')
