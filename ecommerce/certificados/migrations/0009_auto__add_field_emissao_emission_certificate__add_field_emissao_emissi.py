...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Emissao.emission_certificate'
        db.add_column(u'certificados_emissao', 'emission_certificate',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Emissao.emission_mail_attachment_path'
        db.add_column(u'certificados_emissao', 'emission_mail_attachment_path',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Emissao.emission_certificate'
        db.delete_column(u'certificados_emissao', 'emission_certificate')

        # Deleting field 'Emissao.emission_mail_attachment_path'
        db.delete_column(u'certificados_emissao', 'emission_mail_attachment_path')
