...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Emissao.emission_reviewer'
        db.add_column(u'certificados_emissao', 'emission_reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'emissoes_revisadas', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Emissao.emission_reviewer'
        db.delete_column(u'certificados_emissao', 'emission_reviewer_id')
