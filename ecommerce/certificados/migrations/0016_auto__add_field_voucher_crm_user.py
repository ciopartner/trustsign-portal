...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voucher.crm_user'
        db.add_column(u'certificados_voucher', 'crm_user',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voucher.crm_user'
        db.delete_column(u'certificados_voucher', 'crm_user')
