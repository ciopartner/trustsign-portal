...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voucher.ssl_code'
        db.add_column(u'certificados_voucher', 'ssl_code',
                      self.gf('django.db.models.fields.CharField')(default='100001', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voucher.ssl_code'
        db.delete_column(u'certificados_voucher', 'ssl_code')
