...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voucher.order_canceled_reason'
        db.add_column(u'certificados_voucher', 'order_canceled_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voucher.order_canceled_reason'
        db.delete_column(u'certificados_voucher', 'order_canceled_reason')
