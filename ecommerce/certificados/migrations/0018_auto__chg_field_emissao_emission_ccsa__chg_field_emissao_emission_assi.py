...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Emissao.emission_ccsa'
        db.alter_column(u'certificados_emissao', 'emission_ccsa', self.gf('django.db.models.fields.files.FileField')(max_length=256, null=True))

        # Changing field 'Emissao.emission_assignment_letter'
        db.alter_column(u'certificados_emissao', 'emission_assignment_letter', self.gf('django.db.models.fields.files.FileField')(max_length=256, null=True))

        # Changing field 'Emissao.emission_phone_proof'
        db.alter_column(u'certificados_emissao', 'emission_phone_proof', self.gf('django.db.models.fields.files.FileField')(max_length=256, null=True))

        # Changing field 'Emissao.emission_address_proof'
        db.alter_column(u'certificados_emissao', 'emission_address_proof', self.gf('django.db.models.fields.files.FileField')(max_length=256, null=True))

        # Changing field 'Emissao.emission_evcr'
        db.alter_column(u'certificados_emissao', 'emission_evcr', self.gf('django.db.models.fields.files.FileField')(max_length=256, null=True))

        # Changing field 'Emissao.emission_id'
        db.alter_column(u'certificados_emissao', 'emission_id', self.gf('django.db.models.fields.files.FileField')(max_length=256, null=True))

        # Changing field 'Emissao.emission_articles_of_incorporation'
        db.alter_column(u'certificados_emissao', 'emission_articles_of_incorporation', self.gf('django.db.models.fields.files.FileField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Emissao.emission_ccsa'
        db.alter_column(u'certificados_emissao', 'emission_ccsa', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Emissao.emission_assignment_letter'
        db.alter_column(u'certificados_emissao', 'emission_assignment_letter', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Emissao.emission_phone_proof'
        db.alter_column(u'certificados_emissao', 'emission_phone_proof', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Emissao.emission_address_proof'
        db.alter_column(u'certificados_emissao', 'emission_address_proof', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Emissao.emission_evcr'
        db.alter_column(u'certificados_emissao', 'emission_evcr', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Emissao.emission_id'
        db.alter_column(u'certificados_emissao', 'emission_id', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Emissao.emission_articles_of_incorporation'
        db.alter_column(u'certificados_emissao', 'emission_articles_of_incorporation', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'certificados.emissao': {
            ...
            'emission_address_proof': ('django.db.models.fields.files.FileField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            ...
            'emission_articles_of_incorporation': ('django.db.models.fields.files.FileField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'emission_assignment_letter': ('django.db.models.fields.files.FileField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'emission_ccsa': ('django.db.models.fields.files.FileField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            ...
            'emission_evcr': ('django.db.models.fields.files.FileField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'emission_id': ('django.db.models.fields.files.FileField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'emission_mail_attachment_path': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'emission_phone_proof': ('django.db.models.fields.files.FileField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
        ...
        u'certificados.voucher': {
            'Meta': {'ordering': "(u'customer_cnpj', u'ssl_product', u'ssl_line', u'ssl_term', u'order_date')", 'object_name': 'Voucher'},
            'comodo_order': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'crm_hash': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
            'crm_user': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'customer_address1': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'customer_address2': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32', 'blank': 'True'}),
            'customer_address3': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '128', 'blank': 'True'}),
            'customer_address4': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '128', 'blank': 'True'}),
            ...
            'customer_tradename': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '128', 'blank': 'True'}),
            ...
            'order_line': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'vouchers'", 'null': 'True', 'to': u"orm['order.Line']"}),
            ...
            'ssl_line': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'ssl_password': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'ssl_product': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            ...
            'ssl_term': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
        ...
        u'order.order': {
            ...
            'currency': ('django.db.models.fields.CharField', [], {'default': "u'BRL'", 'max_length': '12'}),
        ...
        u'partner.stockrecord': {
            ...
            'partner_sku': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'price_currency': ('django.db.models.fields.CharField', [], {'default': "u'BRL'", 'max_length': '12'}),
