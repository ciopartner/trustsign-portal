...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Emissao.emission_error_message'
        db.add_column(u'certificados_emissao', 'emission_error_message',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Emissao.emission_error_message'
        db.delete_column(u'certificados_emissao', 'emission_error_message')
