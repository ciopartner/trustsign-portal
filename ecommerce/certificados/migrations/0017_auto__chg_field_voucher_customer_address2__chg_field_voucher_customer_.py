...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Voucher.customer_address2'
        db.alter_column(u'certificados_voucher', 'customer_address2', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Voucher.customer_address3'
        db.alter_column(u'certificados_voucher', 'customer_address3', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Voucher.customer_address4'
        db.alter_column(u'certificados_voucher', 'customer_address4', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Voucher.customer_address2'
        db.alter_column(u'certificados_voucher', 'customer_address2', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Voucher.customer_address3'
        db.alter_column(u'certificados_voucher', 'customer_address3', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Voucher.customer_address4'
        db.alter_column(u'certificados_voucher', 'customer_address4', self.gf('django.db.models.fields.CharField')(max_length=64))
