...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.rename_column(u'certificados_emissao', 'emission_fqdns', 'emission_urls')

    def backwards(self, orm):
        db.rename_column(u'certificados_emissao', 'emission_urls', 'emission_fqdns')
    ...
    models = {
        ...
        u'certificados.emissao': {
            ...
            'emission_address_proof': (
                'django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'emission_approver': ('django.db.models.fields.related.ForeignKey', [],
                                  {'blank': 'True', 'related_name': "u'emissoes_aprovadas'", 'null': 'True',
                                   'to': u"orm['auth.User']"}),
            'emission_articles_of_incorporation': (
                'django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'emission_assignment_letter': (
                'django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'emission_ccsa': (
                'django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'emission_certificate': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'emission_cost': ('django.db.models.fields.DecimalField', [],
            ...
            'emission_error_message': (
                'django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'emission_evcr': (
                'django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'emission_id': (
                'django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'emission_mail_attachment_path': (
                'django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'emission_phone_proof': (
                'django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'emission_primary_dn': (
                'django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'emission_publickey_sendto': (
                'django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'emission_reviewer': ('django.db.models.fields.related.ForeignKey', [],
                                  {'blank': 'True', 'related_name': "u'emissoes_revisadas'", 'null': 'True',
                                   'to': u"orm['auth.User']"}),
            'emission_revoke_password': (
                'django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            ...
            'requestor_user': ('django.db.models.fields.related.ForeignKey', [],
                               {'related_name': "u'emissoes'", 'to': u"orm['auth.User']"}),
            'voucher': ('django.db.models.fields.related.OneToOneField', [],
                        {'related_name': "u'emissao'", 'unique': 'True', 'to': u"orm['certificados.Voucher']"})
        },
        u'certificados.revogacao': {
            'Meta': {'object_name': 'Revogacao'},
            'crm_hash': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
            'emission': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "u'revogacoes'", 'to': u"orm['certificados.Emissao']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'certificados.voucher': {
            ...
            'customer_address2': (
                'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '8', 'blank': 'True'}),
            'customer_address3': (
                'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32', 'blank': 'True'}),
            'customer_address4': (
                'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '64', 'blank': 'True'}),
            'customer_callback_email': (
                'django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'customer_callback_firstname': (
                'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '128', 'blank': 'True'}),
            'customer_callback_lastname': (
                'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '128', 'blank': 'True'}),
            'customer_callback_note': (
                'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '128', 'blank': 'True'}),
            'customer_callback_phone': (
                'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '16', 'blank': 'True'}),
            'customer_callback_title': (
                'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '8', 'blank': 'True'}),
