...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrustSignProfile.foto'
        db.add_column(u'home_trustsignprofile', 'foto',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrustSignProfile.foto'
        db.delete_column(u'home_trustsignprofile', 'foto')
