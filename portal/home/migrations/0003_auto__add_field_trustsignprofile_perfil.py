...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrustSignProfile.perfil'
        db.add_column(u'home_trustsignprofile', 'perfil',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrustSignProfile.perfil'
        db.delete_column(u'home_trustsignprofile', 'perfil')
