...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrustSignProfile.crm_user'
        db.add_column(u'home_trustsignprofile', 'crm_user',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrustSignProfile.crm_user'
        db.delete_column(u'home_trustsignprofile', 'crm_user')
    ...
    models = {
        ...
        u'home.trustsignprofile': {
            ...
            'cliente_nomefantasia': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '128', 'blank': 'True'}),
