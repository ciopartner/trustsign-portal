...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrustSignProfile.cliente_ecommerce'
        db.add_column(u'home_trustsignprofile', 'cliente_ecommerce',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrustSignProfile.cliente_tipo_negocio'
        db.add_column(u'home_trustsignprofile', 'cliente_tipo_negocio',
                      self.gf('django.db.models.fields.CharField')(default=u'Other', max_length=128),
                      keep_default=False)

        # Adding field 'TrustSignProfile.cliente_fonte_potencial'
        db.add_column(u'home_trustsignprofile', 'cliente_fonte_potencial',
                      self.gf('django.db.models.fields.CharField')(default=u'Website', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrustSignProfile.cliente_ecommerce'
        db.delete_column(u'home_trustsignprofile', 'cliente_ecommerce')

        # Deleting field 'TrustSignProfile.cliente_tipo_negocio'
        db.delete_column(u'home_trustsignprofile', 'cliente_tipo_negocio')

        # Deleting field 'TrustSignProfile.cliente_fonte_potencial'
        db.delete_column(u'home_trustsignprofile', 'cliente_fonte_potencial')
    ...
    models = {
        ...
        u'home.trustsignprofile': {
            ...
            'cliente_fonte_potencial': ('django.db.models.fields.CharField', [], {'default': "u'Website'", 'max_length': '128'}),
            ...
            'cliente_tipo_negocio': ('django.db.models.fields.CharField', [], {'default': "u'Other'", 'max_length': '128'}),
