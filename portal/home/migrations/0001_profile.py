...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrustSignProfile'
        db.create_table('home_trustsignprofile', (
        ...
        db.send_create_signal('home', ['TrustSignProfile'])


    def backwards(self, orm):
        # Deleting model 'TrustSignProfile'
        db.delete_table('home_trustsignprofile')
