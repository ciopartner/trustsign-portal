...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrustSignProfile.cliente_nomefantasia'
        db.add_column(u'home_trustsignprofile', 'cliente_nomefantasia',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrustSignProfile.cliente_nomefantasia'
        db.delete_column(u'home_trustsignprofile', 'cliente_nomefantasia')
