$(document).ready(function () {
    ...
    function add_product(product_code, line, term, quantity, show_additional, additional_code, additional_price){
        ...
        function add_success(data){
            ...
            $message.html("<div class=\"alert alert-success\" id=\"sucessMessage\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button>Foi adicionado ao seu carrinho " + quantity + " ite" + (quantity > 1 ? "ns" : "m") +  ". <a href='" + url_ecommerce + "basket'>Clique aqui</a> para visualizá-lo.</div>");
