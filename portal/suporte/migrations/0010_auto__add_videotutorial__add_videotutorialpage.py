...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'suporte_videotutorial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('descricao', self.gf('mezzanine.core.fields.RichTextField')()),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='videos', to=orm['suporte.VideoTutorialPage'])),
            ('video_url', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('video_thumb', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'suporte', ['VideoTutorial'])

        # Adding model 'VideoTutorialPage'
        db.create_table(u'suporte_videotutorialpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'suporte', ['VideoTutorialPage'])


    def backwards(self, orm):
        # Deleting model 'VideoTutorial'
        db.delete_table(u'suporte_videotutorial')

        # Deleting model 'VideoTutorialPage'
        db.delete_table(u'suporte_videotutorialpage')
