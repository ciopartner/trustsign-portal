...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ManualPage'
        db.create_table(u'suporte_manualpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'suporte', ['ManualPage'])

        # Adding model 'Manual'
        db.create_table(u'suporte_manual', (
            ...
            ('pagina', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manuais', to=orm['suporte.ManualPage'])),
        ))
        db.send_create_signal(u'suporte', ['Manual'])


    def backwards(self, orm):
        # Deleting model 'ManualPage'
        db.delete_table(u'suporte_manualpage')

        # Deleting model 'Manual'
        db.delete_table(u'suporte_manual')
