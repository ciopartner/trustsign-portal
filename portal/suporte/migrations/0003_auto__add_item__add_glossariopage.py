...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Item'
        db.create_table(u'suporte_item', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pagina', self.gf('django.db.models.fields.related.ForeignKey')(related_name='itens', to=orm['suporte.GlossarioPage'])),
            ('termo', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('descricao', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'suporte', ['Item'])

        # Adding model 'GlossarioPage'
        db.create_table(u'suporte_glossariopage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'suporte', ['GlossarioPage'])


    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table(u'suporte_item')

        # Deleting model 'GlossarioPage'
        db.delete_table(u'suporte_glossariopage')
