...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        ContentType.objects.filter(app_label='products', model__in=['faqpage', 'question']).update(app_label='suporte')

    def backwards(self, orm):
        ContentType = orm['contenttypes.ContentType']
        ContentType.objects.filter(app_label='suporte', model__in=['faqpage', 'question']).update(app_label='products')
