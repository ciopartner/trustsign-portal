...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('products', "0004_auto__add_question__add_faqpage"),
    )

    def forwards(self, orm):
        db.rename_table('products_question', 'suporte_question')
        db.rename_table('products_faqpage', 'suporte_faqpage')

    def backwards(self, orm):
        db.rename_table('suporte_question', 'products_question')
        db.rename_table('suporte_faqpage', 'products_faqpage')
    ...
    models = {
        ...
        u'generic.assignedkeyword': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keyword': ('django.db.models.fields.related.ForeignKey', [],
                        {'related_name': "'assignments'", 'to': u"orm['generic.Keyword']"}),
        ...
        u'pages.page': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_menus': ('mezzanine.pages.fields.MenusField', [],
                         {'default': '(1, 2, 3)', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'in_sitemap': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'keywords': ('mezzanine.generic.fields.KeywordsField', [],
                         {'object_id_field': "'object_pk'", 'to': u"orm['generic.AssignedKeyword']",
                          'frozen_by_south': 'True'}),
            'keywords_string': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            'login_required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [],
                       {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['pages.Page']"}),
        ...
        u'suporte.glossariopage': {
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [],
                          {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'suporte.item': {
            'Meta': {'ordering': "('termo',)", 'object_name': 'Item'},
            'descricao': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pagina': ('django.db.models.fields.related.ForeignKey', [],
                       {'related_name': "'itens'", 'to': u"orm['suporte.GlossarioPage']"}),
        ...
        u'suporte.manual': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pagina': ('django.db.models.fields.related.ForeignKey', [],
                       {'related_name': "'manuais'", 'to': u"orm['suporte.ManualPage']"}),
