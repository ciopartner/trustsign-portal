...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'suporte_tutorial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titulo', self.gf('django.db.models.fields.TextField')()),
            ('texto', self.gf('mezzanine.core.fields.RichTextField')()),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tutoriais', to=orm['suporte.TutorialPage'])),
        ))
        db.send_create_signal(u'suporte', ['Tutorial'])

        # Adding model 'TutorialPage'
        db.create_table(u'suporte_tutorialpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'suporte', ['TutorialPage'])


        # Changing field 'Question.answer'
        db.alter_column(u'suporte_question', 'answer', self.gf('mezzanine.core.fields.RichTextField')())

    def backwards(self, orm):
        # Deleting model 'Tutorial'
        db.delete_table(u'suporte_tutorial')

        # Deleting model 'TutorialPage'
        db.delete_table(u'suporte_tutorialpage')


        # Changing field 'Question.answer'
        db.alter_column(u'suporte_question', 'answer', self.gf('django.db.models.fields.TextField')())
